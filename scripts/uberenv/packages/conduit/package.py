...
class Conduit(Package):
    ...
    depends_on("hdf5@1.8.19:1.8.999~cxx~fortran", when="+hdf5+hdf5_compat+shared")
    depends_on("hdf5@1.8.19:1.8.999~shared~cxx~fortran", when="+hdf5+hdf5_compat~shared")
    depends_on("hdf5~cxx~fortran", when="+hdf5~hdf5_compat+shared")
    depends_on("hdf5~shared~cxx~fortran", when="+hdf5~hdf5_compat~shared")
